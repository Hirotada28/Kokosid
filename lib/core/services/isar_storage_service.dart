...
class IsarStorageService implements LocalStorageService {
  ...
  Future<User?> getUserByUuid(String uuid) async {
    return _db.users.filter().uuidEqualTo(uuid).findFirst();
  }
  ...
  Future<User?> getFirstUser() async {
    return _db.users.where().findFirst();
  }

  @override
  Future<bool> deleteUserByUuid(String uuid) async {
    return _db.writeTxn(
        () async => _db.users.filter().uuidEqualTo(uuid).deleteFirst());
  }
  ...
  Future<Task?> getTaskByUuid(String uuid) async {
    return _db.tasks.filter().uuidEqualTo(uuid).findFirst();
  }

  @override
  Future<List<Task>> getTasksByUserUuid(String userUuid) async {
    return _db.tasks.filter().userUuidEqualTo(userUuid).findAll();
  }
  ...
  Future<bool> deleteTaskByUuid(String uuid) async {
    return _db.writeTxn(
        () async => _db.tasks.filter().uuidEqualTo(uuid).deleteFirst());
  }
  ...
  Future<JournalEntry?> getJournalEntryByUuid(String uuid) async {
    return _db.journalEntrys.filter().uuidEqualTo(uuid).findFirst();
  }
  ...
  Future<SelfEsteemScore?> getSelfEsteemScoreByUuid(String uuid) async {
    return _db.selfEsteemScores.filter().uuidEqualTo(uuid).findFirst();
  }

  @override
  Future<List<SelfEsteemScore>> getSelfEsteemScoresByUserUuid(
      String userUuid) async {
    return _db.selfEsteemScores
        .filter()
        .userUuidEqualTo(userUuid)
  ...
  Future<SuccessExperience?> getSuccessExperienceByUuid(String uuid) async {
    return _db.successExperiences.filter().uuidEqualTo(uuid).findFirst();
  }

  @override
  Future<List<SuccessExperience>> getSuccessExperiencesByUserUuid(
      String userUuid) async {
    return _db.successExperiences
        .filter()
        .userUuidEqualTo(userUuid)
        .sortByCreatedAtDesc()
        .findAll();
  ...
  Future<int> deleteAllSuccessExperiencesByUserUuid(String userUuid) async {
    return _db.writeTxn(() async =>
        _db.successExperiences.filter().userUuidEqualTo(userUuid).deleteAll());
  }
